...
import SearchBar from './SearcBar'; // Adjust the path based on your project structure
...
function Home() {
  ...
  return (
    <div className="home-container">
      ...
      {/* Include the SearchBar component and pass shoeData and handleSearch function */}
      <SearchBar shoeData={shoes} onSearch={handleSearch} />

      <div className="shoes-container">
        {/* Map out the filtered shoes */}
